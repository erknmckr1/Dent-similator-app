...
// --- MOCK DATA: HASTALAR ---
const PATIENTS = [
  { value: "p1", label: "Ahmet Yılmaz", phone: "555-123" },
  { value: "p2", label: "Ayşe Demir", phone: "532-999" },
  { value: "p3", label: "Mehmet Öz", phone: "505-000" },
  { value: "p4", label: "Zeynep Kaya", phone: "533-111" },
];
...
export default function DentalSimulator() {
  ...
  const handleGenerate = async () => {
    ...
    formData.append('similationType',selectedType.id)
